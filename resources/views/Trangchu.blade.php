            ...
            <div class="space60">&nbsp;</div>
                <div class="row">
                    <div class="col-sm-12">
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-caption">
                                            ...
                                            <a class="beta-btn primary" href="detailProduct/{{$new->id}}">Details <i class="fa fa-chevron-right"></i></a>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                </div>
						...
						<div class="beta-products-list">
							<h4>Top Products Promotion</h4>
							<div class="beta-products-details">
                                <p class="pull-left">Found {{ $sanpham_khuyenmai ? $sanpham_khuyenmai->count() : 0 }} products</p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
                            @foreach($sanpham_khuyenmai as $spkm)
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="shopping_cart.html"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="detailProduct/{{$spkm->id}}">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
