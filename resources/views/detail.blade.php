            ...
            <div class="beta-products-list">																
                ...
                <div class="col-sm-4">																
                    ...
                    <div class="single-item-header">																
                        <a href="detailProduct/{{$sp->id}}"><img src="/source/image/product/{{$sp->image}}" alt=""></a>																
                    </div>																
                    ...
                    <div class="single-item-caption">																
                        <a class="add-to-cart pull-left" href="#"><i																
                            ...
                            <a class="beta-btn primary" href="{{ route('detailProduct', ['id' => $sp->id]) }}">Details <i class="fa fa-chevron-right"></i></a>														
                        <div class="clearfix"></div>																
                    </div>																
                    </div>																
                </div>																
